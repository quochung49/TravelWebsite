...
<!--                    <form action="search" method="get" class="d-flex" role="search">
        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 mt-5">
                ...
                <div class="text-center">
                    <pager:pager pageIndex="${pageIndex}" totalPages="${totalPages}" pageSize="${pageSize}" displayPages="5"/>
                </div>
        ...
        <div class="modal" id="logoutModal" tabindex="-1">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h6 class="text-success" id="errorModalBody">Logout Successfully</h6>
        ...
        <script>
            $(document).ready(function () {
                ...
                if (<c:out value="${sessionScope.isLogout != null && sessionScope.isLogout}"/>) {
                    $('#logoutModal').modal('show');
                    <c:remove var="isLogout" scope="session"/>
                }
            });
            
            
            function loadBookList(pageIndex, pageSize) {
                $.get('productlist', {pageIndex: pageIndex, pageSize: pageSize}, function (data) {
                    $('body').html(data);
                    console.log(data);
                });
            }
